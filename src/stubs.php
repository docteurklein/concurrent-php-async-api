...
namespace Concurrent
{
    ...
    final class ChannelGroup implements \Countable
    {
         ...
         * @param int $timeout Operation timeout (in milliseconds), use NULL to disable timeouts.
         ...
         * 
         * @param mixed $value Optional reference to a variable that shall be populated with the received message.
         * @return mixed The key of the selected channel (as specified in the input channel array) or NULL.
         * 
    ...
    {        
        /**
         * Is true when if the context has been cancelled.
         * 
         * @var bool
         */
        public $cancelled;
    ...
    final class Task implements Awaitable
    {
        ...
        /**
         * Name of the file where the task has been created.
         * 
         * @var string
         */
        public $file;
        ...
        /**
         * Line number within the file where the task has been created.
         *
         * @var string
         */
        public $line;
    ...
    /**
     * Is thrown on behalf of errors that occured during job execution.
     */
    final class JobFailedException extends \Exception { }
    
    /**
     * Creates a pool of threads that can be used to offload work.
     */
    final class ThreadPool
    {
         ...
         *
         * @param int $size Number of threads to launch (must be between 1 and 64).
         * @param string $bootstrap Bootstrap file (likely autoloader) to run before the thread accepts jobs.
         */
        public function __construct(?int $size = null, ?string $bootstrap = null) { }
        
        /**
         * Check if the thread pool can be used (requires ZTS and PHP has to be run from the command line).
         */
        public static function isAvailable(): bool { }
        
        /**
         * Close the thread pool, no more work can be queued, pending jobs will run to completion.
         *
        ...
        /**
         * Enqueue the given job for execution by a worker thread.
         *
         * All arguments and return values need to be scalar types or arrays.
         *
         * Objects cannot be passed between threads.
         *
         * @param \Closure $work Contains code to be executed by a worker.
         * @param mixed ...$args Arguments passed to the job callback.
         */
...
namespace Concurrent\Network
{
    ...
    final class UdpSocket implements Socket
    {
         ...
         * 
         * You shoul always call this method before close() if you are working with async sends, failing to
